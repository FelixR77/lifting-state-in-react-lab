...
import IngredientList from './components/IngredientList/IngredientList.jsx';'./components/IngredientList/IngredientList.jsx'
...
const App = () => {
  ...
  setStack(prevStack =>
    prevStack.filter(item => item !== ingredientToRemove)
  );
};
